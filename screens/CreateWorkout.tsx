...
async function createWorkout(
  ...
  workoutName: string,
  days: { dayName: string; exercises: { exerciseName: string; sets: number; reps: number; muscle_group: string | null; rest_seconds: number | null }[] }[]
) {
      ...
      for (const day of days) {
        ...
        for (const exercise of day.exercises) {
          ...
          await db.runAsync(
            ...
            [dayId, exercise.exerciseName, exercise.sets, exercise.reps, exercise.muscle_group, exercise.rest_seconds ?? null]
          );
        }
      }
    } catch (error) {
